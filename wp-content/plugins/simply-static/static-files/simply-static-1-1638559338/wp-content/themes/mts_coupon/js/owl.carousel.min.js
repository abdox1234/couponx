...
if ( slideropts.fade_effect === '1' ) slideAnimation = 'fadeOut';

// remove image attrs on document ready (except first image in slider)
jQuery(document).ready(function($) {

	jQuery('.coupon-carousel').each(function () {
	...
	$('.slide-first-img').imagesLoaded(function() {
		...
		//Home Slider
		if ( jQuery('.coupon-carousel').length ) {
			jQuery('.coupon-carousel').each(function() {
				var carouselSlider = jQuery(this),
					carouselSliderContainer = carouselSlider.closest('.coupon-carousel-container');
				...
				carouselSlider.owlCarousel({
					...
					onInitialize: function(){
						if ( carouselSlider.find('.item').length == 1 ) {
		...
		if ( jQuery('.primary-slider').length ) {
			jQuery('.primary-slider').each(function() {
				...
				primarySlider.owlCarousel({
					...
					onInitialized: function(){
						primarySliderContainer.loadImages().removeClass('loading');
					},
				});
			});
		}
